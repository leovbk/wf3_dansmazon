...
class __TwigTemplate_e2ce267f4fc6aa13da9a20b140f7a38fe3aa32f267838d4cc3f09b47c06e40b9 extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 10
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 10, $this->source); })()), "confirm_password", [], "any", false, false, false, 10), 'row');
        echo "
...
";
    ...
    {
        return array (  113 => 12,  108 => 10,  104 => 9,  100 => 8,  96 => 7,  92 => 6,  87 => 3,  77 => 2,  36 => 1,);
    }
...
{% endblock %}
", "security/registration.html.twig", "/Users/macdeleo/Desktop/dansmazone/dansmazone/templates/security/registration.html.twig");
    }
}
